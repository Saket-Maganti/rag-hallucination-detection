"""
scripts/build_colab_tutorial.py — Phase 5 #11
=============================================

Generates a Colab-ready tutorial notebook walking through CCS + the
refinement paradox in 6 cells. Designed to take a fresh user from
"I clicked the link" to "I just reproduced the headline plot" in
under 5 minutes (free Colab CPU).

Outputs:
    notebooks/colab_tutorial.ipynb

Usage:
    python3 scripts/build_colab_tutorial.py
"""
...
OUT = ROOT / "notebooks" / "colab_tutorial.ipynb"
...
CELLS = [
    cell("markdown", (
        ...
        "(https://colab.research.google.com/github/Saket-Maganti/rag-hallucination-detection/blob/main/notebooks/colab_tutorial.ipynb)\n"
        "\n"
        "This 6-cell notebook walks you through the **Context Coherence Score (CCS)** "
        "and the **refinement paradox** from Maganti (2026) — *\"When Better Retrieval "
        "Hurts: Context Coherence Drives Faithfulness in RAG\"*.\n"
        "\n"
...
def main():
    nb = {
        ...
        "metadata": {
            ...
            "colab": {"name": "Coherence Paradox Tutorial", "provenance": []},
        },
        "cells": CELLS,
    }
    OUT.parent.mkdir(parents=True, exist_ok=True)
    OUT.write_text(json.dumps(nb, indent=1))
    print(f"[colab] wrote {OUT.relative_to(ROOT)}")
    print(f"[colab] open at: https://colab.research.google.com/github/"
          f"Saket-Maganti/rag-hallucination-detection/blob/main/notebooks/colab_tutorial.ipynb")
