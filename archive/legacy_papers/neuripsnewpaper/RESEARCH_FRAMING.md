...
2. If coherence is causal, HIGH-CCS contexts should beat LOW-CCS contexts at
...
diagnostic variable rather than a mechanism.

## Latest Empirical State

- The causal CCS mechanism is rejected in the primary matched-similarity test.
...
> The released benchmark operationalizes these controls and exposes which RAG
> claims survive matched similarity, multi-metric scoring, threshold transfer,
> and Pareto accounting.
