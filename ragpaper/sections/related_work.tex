...
refinement paradox---and its cause: a meso-level property of the
retrieved context, coherence. This perspective unifies several
...
\citet{xu2024hallucination} have argued that hallucination is an
inherent property of autoregressive generation; our results add that in
RAG settings, hallucination is also a property of the retrieval
